          ...
          ({
            ...
            >
              <Link
                href={url.url}
                target="_blank"
                className="focus:outline-offset-6 flex w-fit items-center gap-2 text-muted-foreground underline decoration-1 underline-offset-8 transition-colors hover:cursor-ne-resize hover:text-foreground"
              >
